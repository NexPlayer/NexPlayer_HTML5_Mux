var NexMuxHandShake = function(){
  ...
  this.videoChange = function (muxConfig) {
    mux.emit('#nexplayer_videoplayer', 'videochange', muxConfig.data);
  };

  this.programChange = function (muxConfig) {
    mux.emit('#nexplayer_videoplayer', 'programchange', muxConfig.data);
  };
